...
```{r ans22}
taiwan_time<- lubridate::ymd_hms("西元2019年4月12 12點55分30秒",
        tz="Asia/Taipei")
taiwan_time <-
  ymd_hms(
    c("西元2019年4月12", "12點55分30秒"),
    tz="Asia/Taipei"
  )
oslo_time <-
  ymd_hms("18.11.2018", "15:33:02")
...
fromJSON("http://data.ntpc.gov.tw/api/v1/rest/datastore/382000000A-000328-002")
